    ...
    <div class="row m-t-40">         
      <div class="col-xs-12 col-md-10 col-md-offset-1">
        <div class="col-xs-12 div-ubicacion">
          ...
          <h1 class="p-0 m-0 light" >Para gestionar tu pr&eacute;stamo, te esperamos en nuestra agencia de <?php echo $Agencia ?> con tu <span class="negrita"> DNI </span><span class="negrita"> y un recibo de servicio</span> (luz, agua, tel&eacute;fono) con antiguedad no mayor a dos meses y tus dos últimas voletas de pago.</br>
