    ...
    <div class="row m-t-40">         
      <div class="col-xs-12 col-md-10 col-md-offset-1">
        <div class="col-xs-12 div-ubicacion">
          ...
          <h1 class="ajustar negrita" ><b>Solicitaste un cr&eacute;dito de <?php echo 'S/ '.number_format($Importe, 2)?> a <?php echo $cant_meses ?> meses con una cuota de S/ <?php echo number_format($cuota_mensual, 2) ?></b></h1><br />
