  ...
  <head>
        ...
        <div class="container-fluid">
          ...
          <div class="navbar-header">
            ...
            <div class="form-group">
            	<a class="navbar-brand" href="#">
            		<div class="text-left class1" style="position: relative;top: -10px;right: 100px;">
                		<h1 style="font-size: 39px;">&iexcl;Te financiamos hasta</h1>
                	</div>
                	<div class="text-left" style="position: relative;right: 100px;">
                		<h1 style="font-size: 39px;margin: -11px;">el 100% de tu auto!*</h1>
                	</div>
            </a>
            </div>
          </div>
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right">
                  <li class="">
                  		<img class="img-responsive hidden-xs logo" style="height: 97px;width: 302px;position: relative;top: 10px;" alt="" src="<?php echo RUTA_IMG?>fondos/Logo-Prymera-Blanco.png">
                  </li>
            </ul>
          </div>
       </div>
    ...
    <div class="container fondo">
    	<div class="row" style="margin-top: 123px;">
    		<div class="col-md-6 text-left">
		    	<div class="panel panel-primary" style="border:none;background: rgba(255,255,255,0.6);max-width: 461px;">
			    	...
			    	<div class="panel-body" style="background-color: #fff;">
			    		<form class="text-center">
						  ...
						  <div class="form-group">
						  	<label for="Nombre" style="font-size: 15px;color: #a3a4a6;position: relative;bottom: 2px;left: -123px;font-weight: normal;">Ingresa tus datos</label>
						...
						<form class="text-center">
    						  <div class="form-group">
    						  	<div class="checkbox">
    						    	<label style="font-size:13px;position: relative;left: -75px;color:#9fa9a3;">
    						...
    						<div class="form-group">
    							<div class=row>
        							<div class="col-xs-4 col-md-6">
            						  	<div class="checkbox" style="width: 137%;border: 1px solid #ccc;background: #f0f0f0;margin: 0px;padding: 20px;">
            						        <label>
    ...
    <!--             						    <div class="g-recaptcha" data-sitekey="6Le9zh8UAAAAAKn-kpHg2Ls7MfqsiOznS7Pp94ja"></div> -->
            						...
            						<div class="col-xs-6 col-md-6">
            							<button type="button" class="btn btn-lg" style="width: 111%;font-weight:bold;color: #fff;background-color: #007ac0;position: relative;right: -47px;bottom: 1px;height: 65px;" onclick="solicitarPrestamo()">Consultar</button>
            						</div>
    							</div>
    						</div>
					  	</form>
					  	<form class="text-center">
					  		<p style="font-size: 12px;color: #9fa9a3;position: relative;bottom: -9px;left: -42px;">*El cr&eacute;dito vehicular "Auto de Prymera" est&acute; sujeto a evaluaci&oacute;n</p>
					  	</form>
			    	</div>
		    	</div>
