...
<html lang="en">
  <head>
    ...
    <link type="text/css"       rel="stylesheet"    href="<?php echo RUTA_CSS?>micash-losentimos.css?v=<?php echo time();?>">
    ...
    <div class="container-fluid">
      <div class="navbar-header" style="position: relative;left: 90px;">
