                  ...
                  <form class="text-center" action="losentimos.html" method="POST">
                    ...
                    <div class="col-xs-12 border-resumen-bottom">
                        <div class="form-group" style="">                
                          ...
                          <div class="col-xs-6">
                            <span>S/ <?php echo number_format($valor_auto,2) ?></span>
                          </div>
                        </div>
                    </div>
                    <div class="col-xs-12 border-resumen-bottom">
