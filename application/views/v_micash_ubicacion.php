            ...
            <div class="mdl-content-cards">
                <div class="mdl-card cuadro" style="">
                    ...
                    <div>
                        ...
                        <h1 class="ajustar negrita" ><b>Solicitaste un cr&eacute;dito de <?php if ($tipo_producto == PRODUCTO_VEHICULAR) { ?>S/ <?php } ?> <?php echo $Importe ?> soles a <?php echo $cant_meses ?> con una cuota de <?php echo $cuota_mensual ?> soles</b></h1><br />
