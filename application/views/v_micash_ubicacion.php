    ...
    <div class="row m-t-40">         
      <div class="col-xs-12 col-md-10 col-md-offset-1">
        <div class="col-xs-12 div-ubicacion">
          ...
          <h1 class="ajustar negrita" ><b>Solicitaste un cr&eacute;dito de <?php if ($tipo_producto == PRODUCTO_VEHICULAR) { ?>  <?php echo 'S/ '.$Importe.'.00'?> <?php }else{ ?> <?php echo $Importe.'.00' ?> <?php }?> a <?php echo $cant_meses ?> con una cuota de <?php echo $cuota_mensual ?></b></h1><br />
