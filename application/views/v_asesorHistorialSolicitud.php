        ...
        <div class="col-xs-12">
          ...
          <div class="col-xs-12">
            <ul class="nav nav-tabs">
              <li><a href="/C_reporteAsesor/asesorCliente">Agente - CLiente</a></li>
              <li class="active"><a href="/C_reporteAsesor/asesorHistorialSolicitud" class="nav-active-a">Historial Solicitud</a></li>
            </ul>
          </div>
