                    				...
                    				<div class="col-xs-12">
                		    			<form class="text-center form-horizontal">
                            				<div class="col-xs-12 col-md-6" style="color:black;font-size:16px;position: relative;top: 30px;">
                                            	<div class="col-md-6">
                                            		<select class="form-control" style="position:relative;left: 40px;top: -18px;" name="marca" title="Selec. Tipo de pago" id="tipoPago">
                                				...
                                				<div class="col-md-6" style="position: relative;top: 15px;">
                                					<div class="col-xs-6 text-center">
                                						<div class="container" style="position: relative;top: 30px;">
                                      						<ul class="nav nav-pills">
                                								<li id="remove1" class="remove1"><a data-toggle="tab" style="background-color: #005aa6; color: #fff;position: relative;top: -30px;" href="#menu1" onclick="addStyle()">Siguiente</a></li>
                                							</ul>
                                						</div>
                                                    </div>
                                				</div>            
