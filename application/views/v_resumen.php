...
<html lang="en">
  ...
  <!-- Custom fonts for this template -->
    ...
    <link type="text/css"       rel="stylesheet"    href="<?php echo RUTA_CSS?>estilos-resumen.css?v=<?php echo time();?>">
  </head>
    <body style="">
	...
	<script charset="UTF-8" type="text/javascript" async src="<?php echo RUTA_JS?>jsresumen.js?v=<?php echo time();?>"></script>
