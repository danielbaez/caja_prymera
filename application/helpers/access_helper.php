	...
	$permission = [
					'administrador' => [
						'C_main' => ['index', 'registrar'],
					   	...
					   	'C_ip' => ['index', 'save'],
					   	'C_reporte' => ['solicitudes', 'agenteCliente', 'historialSolicitud', 'ajaxHistorialSolicitud', 'solicitudRechazada', 'autocompleteGetAsesor', 'modalInformacionSolicitud', 'solicitudesTotales', 'cambiarEstado']
					],
					'jefe_agencia' => [
						'C_main' => ['index', 'registrar'],
