	...
	$permission = [
					'administrador' => [
						'C_main' => ['index', 'registrar'],
					   	...
					   	'C_ip' => ['index', 'save'],
					   	'C_reporte' => ['solicitudes', 'ajaxSolicitudes', 'agenteCliente', 'historialSolicitud', 'ajaxHistorialSolicitud', 'solicitudRechazada', 'autocompleteGetAsesor', 'modalInformacionSolicitud', 'solicitudesTotales', 'cambiarEstado']
					],
					'jefe_agencia' => [
						'C_main' => ['index', 'registrar'],
						'C_usuario' => ['detalleUsuario', 'logout'],
						'C_reporte' => ['solicitudes', 'agenteCliente', 'historialSolicitud', 'ajaxHistorialSolicitud', 'solicitudRechazada', 'autocompleteGetAsesor', 'modalInformacionSolicitud', 'actualizarEstadoSolicitud', 'solicitudesTotales', 'cambiarEstado']
					],
				    'asesor' => [
				   		'C_reporteAsesor' => ['agenteCliente', 'agenteHistorialSolicitud', 'ajaxAgenteHistorialSolicitud', 'modalInformacionSolicitud', 'actualizarNotaSolicitud'],
