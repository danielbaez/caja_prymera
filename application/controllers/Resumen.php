                  ...
                  <body>
                    <div style="    margin: auto;width: 100%;max-width: 600px;height: 2000px;">
                      <div class="container-fluid" style="max-width: 600px;background-color: #0060aa;border-top-left-radius: 40px;">
                        ...
                        <h1 style="font-size: 25px;color: #fff;margin-left: 40px;margin-top: 1px;">'.$nuevo_texto.' <img class="logo-img" src="'.RUTA_IMG.'/fondos/Logo-Prymera-Blanco.png" style="width: 300px;float: right; margin: -37px 20px;padding: 0px 0px;"></h1>
                      </div>
