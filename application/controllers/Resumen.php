...
class Resumen extends CI_Controller {
    ...
    function sendMailGmail() {
      ...
      try {  
       ...
       _getSesion('tipo_producto') == PRODUCTO_MICASH ? $texto_beneficios = '<p style="color: #fff;margin-left: 40px;font-weight: lighter;width: 83%;">Si deseas un '.$credito.' '.$nuevo_texto.' un monto mayor al pre-aprobado, debes llevar tu última boleta de pago para que podamos evaluarte.</p>' : $texto_beneficios = '<p style="color: #fff;margin-left: 40px;font-weight: lighter;width: 83%;">Si deseas un '.$credito.' '.$nuevo_texto.' con un monto mayor al pre-aprobado, debes llevar las 3 últimas boletas de pago (ingreso fijo o variable) y el estado de cuenta vigente de tarjetas de crédito u otros créditos que poseas, para que podamos evaluarte.</p>';
                  ...
                  <!--<div class="container-header" style="background-color: #0060aa;height: 115px;">
                      ...
                      <div class="containet-text" style="width: 100%;height: 360px;background-color: #f1f1f1;margin-top: -30px;font-weight: bold;">
                        ...
                        <div style="height: 350px;padding-top: 40px;">
                          <div style="padding: 20px;border: 1px solid;height: 150px;font-size: 9px;">
